...
(function(win, doc, CSS3D, Matrix4) {
    ...
    var Cube = CSS3D.Object3D.extend({
        ...
        init: function(size, n, index) {
            ...
            // For Middle cube useController is false
            var middle = false;
            if (index in {4:4, 10:10, 14:14, 12:12, 22:22, 16:16} ){
               middle = true;
            }
...
(function(win, doc, Matrix4, Class, CSS3D) {
    ...
    (function() {
        ...
        if (/demo2/i.test(query)) {
            ...
            rubikcube.translate([0, 140, -500]);
        }
        rubikcube.rotateX(-50);
        rubikcube.rotateY(40);
        rubikcube.random(-1); // stop random init cube
